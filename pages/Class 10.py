...
def main():
    ...
    st.title("Maths ChatBot Class 10")
    ...
    with st.sidebar:
        ...
        with st.form(key="chapter_form"):
            chapter = st.selectbox("Chapter Number", list(range(1, 15)))
    ...
    if submit_button: 
        ...
        if language == "***English***":
            pdf_path = f"./NCERT_class_10_eng/{chapter}.pdf"
        elif language == "***Hindi***":
            pdf_path = f"./NCERT_class_10_hin/{chapter}.pdf"
        else:
